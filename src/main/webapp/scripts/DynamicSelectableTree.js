...
function MenuToc_toc(tocName)
{
    ...
    this.listSelectedDescription	= MenuToc_tocListSelectedDescription  // added by Lu Gengbiao
...
// MenuToc_tocMakeItem
// Create a item
function MenuToc_tocMakeItem(description, href,target,icon,value)
{
    newItem = new MenuToc_item(this,description, href,target,icon,value)
    return newItem
}
...
function MenuToc_folderInitTable()
{
    ...
    this.toc.doc.write("<table id='" + this.toc.name + "folder" + this.id + "' style='position:block;' border=0 cellspacing=0 cellpadding=0>\n</table>\n")
       ...
       if (level>0)
		{
           ...
           {
				this.draw(leftSide + auxEv + "<img name='" + this.toc.name + "nodeIcon" + this.id + "' src='" + this.toc.iconPlus1 + "' width=" + this.toc.iconWidth + " height=" + this.toc.iconHeight + " border=0></a>")
				leftSide = leftSide + "<img src='" + this.toc.iconEmpty + "' width=" + this.toc.iconWidth + " height=" + this.toc.iconHeight + ">"
				this.isLastNode = 1
			} else
			{
				this.draw(leftSide + auxEv + "<img name='" + this.toc.name + "nodeIcon" + this.id + "' src='" + this.toc.iconPlus2 + "' width=" + this.toc.iconWidth + " height=" + this.toc.iconHeight + " border=0></a>")
...
{
    this.html = "<table id='" + this.toc.name + "folder" + this.id + "' style='position:block;' border=0 cellspacing=0 cellpadding=0>\n"
    this.html += '<tr><td>'
    this.html += leftSide
...
// MenuToc_item
// Constructor
function MenuToc_item(activeToc, description, href, target, icon, value)
{
    // Data member
    this.id = -1
    this.toc = activeToc
...
{
    this.createIndex()
    this.toc.doc.write("<table id='" + this.toc.name + "item" + this.id + "' style='position:block;' border=0 cellspacing=0 cellpadding=0>\n</table>\n")
...
{
    var html = "<table id='" + this.toc.name + "item" + this.id + "' style='position:block;' border=0 cellspacing=0 cellpadding=0>\n<tr><td>"
...
function MenuToc_tocListSelectedDescription()
{
    var selectedNodes = "";
    ...
    {
        if (this.nodesIndex[i].selected)
            selectedNodes += "," + this.nodesIndex[i].desc;
    }
...
function MenuToc_tocSelectNodes(ids){
    ...
    for (var i=0 ; i < this.nodesCounter; i++){
    	if (tempIds.indexOf(","+this.nodesIndex[i].value+",")>=0){   
    	    var selectedNode = this.nodesIndex[i]; 	
