    ...
    *******************************************************/
    ...
    function initAspectSelect(){
       ...
       if(s.value!=""){
           stdTypeDepart3Select=this;
           var stdTypeSelect= document.getElementById(stdTypeDepart3Select.stdTypeSelectId);
           specialityAspectDAO.getSpecialityAspectNames2(setAspectOptions,s.value,stdTypeSelect.value);
        }
    ...
    function notifyAspectChange(event){
       ...
       for(var i=0;i<mySelects.length;i++){
           ...
           if(s.value!=""){
              ...
              var stdTypeSelect= document.getElementById(mySelects[i].stdTypeSelectId);
              specialityAspectDAO.getSpecialityAspectNames2(setAspectOptions,s.value,stdTypeSelect.value);
           }
       }
    }
