   ...
   if(6==date.getDay()){
    ...
    function save(){
        ...
        document.taskActivityForm.action="manualArrange.do?method=saveActivities&activityCount="+count;
    ...
    function listFreeRoom(containPublicRoom,detectCollision,pageNo,pageSize,configId,stdCount){
       ...
       form.action="manualArrange.do?method=freeRoomList&pageNo="+pageNo+"&pageSize="+pageSize;
             ...
             if(td.style.backgroundColor!="yellow"){
                ...
                var k=0;
             	...
             	for(var i=0;i<num;i++){
	             	...
	             	// change color
	             	origColor[index]=document.getElementById("TD"+index).style.backgroundColor;
                ...
                for(var i=0;i<selectIndexes.length;i++)
             	...
             	for(var i=0;i<num;i++){
             		document.getElementById("TD"+index).style.backgroundColor=origColor[index];
             		index++;
             	}
             }
        }
