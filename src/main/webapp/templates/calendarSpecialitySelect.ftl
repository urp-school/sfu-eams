...
<script>
    ...
    var dd = new StdTypeDepart3Select("stdType","department","speciality","specialityAspect",false,true,true,true);    
...
<script>
    ...
    var dd = new CalendarSelect("stdType","year","term",${stdTypeNullable?string},${yearNullable?string},${termNullable?string});
