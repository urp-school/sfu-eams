...
<#include "/templates/back.ftl"/>   
	<table width="90%" align="center"  class="formTable">
		<form action="teachProjectApply.do?method=save" name="teachProjectForm" method="post" onsubmit="return false;">
		<@searchParams/>
  ...
  function cancelGen(){
     ...
     $("codeGenDiv").style.display="block";
		...
		<tr>
			...
			<td>
	     	<select name="teachProject.teachProjectState.id" style="width:100%" disabled="disabled">
		     	<option value="">...</option>
