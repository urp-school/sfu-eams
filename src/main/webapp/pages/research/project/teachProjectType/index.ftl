...
<BODY LEFTMARGIN="0" TOPMARGIN="0">
 <#assign labInfo>项目类型列表</#assign>
 <#include "/templates/help.ftl"/>
    <table  class="frameTable_title">
        <tr>
	        <td style="width:50px"><font color="blue"><@bean.message key="action.advancedQuery"/></font></td>
            <td>|</td>
           <form name="teachProjectTypeForm" method="post" action="teachProjectType.do?method=index" onsubmit="return false;">
        </tr>
    </table>
    <table class="frameTable_title">
        <tr>
 ...
 <script language="javascript">
    var form=document.teachProjectTypeForm;
    action="teachProjectType.do";
 	function search(){
