...
<script>
  ...
  <table align="center" width="100%" class="frameTable">
	...
	<form name="teachProductForm" method="post" target="teachProductQueryFrame" action="" onsubmit="return false;">
		...
		<tr>
			<td width="35%"><@msg.message key="entity.department"/>:
			</td>
		...
		<tr>
			<td><@msg.message key="field.teachProduct.productType"/>:
			</td>
			<td>
		...
		<tr>
			<td><@msg.message key="field.teachProduct.productionAwardType"/>:
			</td>
		...
		<tr>
			<td><@msg.message key="field.teachProduct.productionAwardLevel"/>:
			</td>
			<td>
		...
		<tr>
			...
			<td><input type="text" name="teachProduct.productName" maxlength="20" style="width:100px" value="">
			</td>
		</tr>
		<tr>
			<td>完成人
...
<script>
    ...
    function search(pageNo,pageSize){
	   form.action="teachProductStat.do?method=search";
