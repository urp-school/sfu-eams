<#include "/templates/head.ftl"/>
 <BODY LEFTMARGIN="0" TOPMARGIN="0">
  ...
  <@table.table width="100%" sortable="true" id="listTable" headIndex="1">
   <form name="taskListForm"  method="post" action="lessonCheck.do?method=taskList" onsubmit="return false;">
  ...
  <script>
    ...
    function addTeachAccident(){
       ...
       form.action='lessonCheck.do?method=edit&lessonCheck.task.id='+taskId;
       form.submit();
    }
    function search(){
