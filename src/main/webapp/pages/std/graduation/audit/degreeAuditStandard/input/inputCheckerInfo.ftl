<#if param.param.type=="OtherExamCategory" && param.param.name=="computerExams">
	<input type="text" id="computerExamNames" value="" style="border:0 solid #000000; width:100%" readOnly="true" maxlength="100"/><br>
...
<#elseif param.param.type=="OtherExamCategory" && param.param.name=="languageGrades">	
	<input type="text" id="languageExamNames" value="" style="border:0 solid #000000; width:100%" readOnly="true" maxlength="100"/><br>
...
<#elseif param.param.type=="PunishmentType" && param.param.name=="lowestPunishType.id">	
	<input type="text" id="punishmentTypes" value="" style="border:0 solid #000000; width:100%" readOnly="true" maxlength="100"/><br>
	...
	<script language="javascript"> 
		var lowestPunishType = "${(param.value)?default("")}";
	</script>
