...
<body>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" border="0">
   ...
   <tr>
    <td align="center" colspan="4" class="contentTableTitleTextStyle" bgcolor="#ffffff" height="30">
     <B><@bean.message key="info.addStudentRecordInfo"/></B>
    </td>
   </tr>
   <tr>
    <td>
  ...
  <script language="javascript">
  	var bar = new ToolBar("bar", "<@msg.message key="info.addStudentRecordInfo"/>", null, true, true);
    ...
    function doAction(form){   
     ...
     var studentInfo_fields = {
         ...
         'statusInfo.enrollDate':{'l':'<@bean.message key="std.enrollDate"/>', 'r':true, 't':'f_enrollDate'},
