	...
	<form name="commonForm" action="studentStatusAlterRequisition.do" method="post" onsubmit="return false;">
		...
		<tr>
			...
			<tr>
				...
				<td class="brightStyle"><input type="text" name="basicInfo.postCode" maxlength="6" style="width:100%;border:1 solid #000000;" value="${std.basicInfo.postCode?default("")?html}" /></td>
				<td align="center" class="darkColumn" id="f_phone"><@bean.message key="attr.phoneOfHome"/><font color="red">*</font></td>
				<td class="brightStyle"><input type="text" name="basicInfo.phone" maxlength="20" style="width:100%;border:1 solid #000000;" value="${std.basicInfo.phone?default("")?html}" /></td>
			</tr>
			<tr>
				<td align="center" class="darkColumn" id="f_alterDate" width="20%">学籍变动日期<font color="red">*</font></td>
				<td class="brightStyle"><input type="text" style="width:100%;border:1 solid #000000;" name="record.alterDate" onfocus="calendar()" size="10" maxlength="10"/></td>
				<td align="center" class="darkColumn"  width="20%">变动截止日期</td>
				<td class="brightStyle"><input type="text" style="width:100%;border:1 solid #000000;" name="record.endDate" onfocus="calendar()" size="10" maxlength="10"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" align="center" class="darkColumn">
				    <input type="hidden" name="method" value="dispatchAlter" />
