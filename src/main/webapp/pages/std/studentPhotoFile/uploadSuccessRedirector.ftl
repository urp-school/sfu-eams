<#include "/templates/head.ftl"/>
 <BODY LEFTMARGIN="0" TOPMARGIN="0" onunload="opener.refreshPhoto();">
  <table  width="100%" cellpadding="0" cellspacing="0">
   ...
   <tr>
         ...
         <a href="javascript: opener.refreshPhoto();self.window.close();">这里</a>
         </td>
   </tr>
  </table>
  <script>
	setTimeout('opener.refreshPhoto()',1000);
