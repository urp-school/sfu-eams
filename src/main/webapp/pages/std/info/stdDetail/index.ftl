   ...
   <td valign="top" class="frameTable_view" width="20%" style="font-size:10pt">
	  ...
	  <tr>
       ...
       <tr>
         ...
         &nbsp;&nbsp;<image src="${static_base}/images/action/list.gif" align="bottom"><@msg.message key="std.survey"/>
         </td>
       </tr>
       <tr>
         <td class="padding"  onclick="info(this,'basicInfo')"  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="${static_base}/images/action/list.gif"><@msg.message key="std.baseInfo"/>
         </td>
       </tr>
       ...
       <tr>
         ...
         &nbsp;&nbsp;<image src="${static_base}/images/action/list.gif"><@msg.message key="std.statusInfo"/>
         </td>
       </tr>
       </#if>
       ...
       <tr>
         ...
         &nbsp;&nbsp;<image src="${static_base}/images/action/list.gif"><@msg.message key="std.certificateInfo"/>
         </td>
       </tr>
       </#if>
       <#if std.degreeInfo?exists>
       <tr>
         <td class="padding"  onclick="info(this,'degreeInfo')"  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
         &nbsp;&nbsp;<image src="${static_base}/images/action/list.gif"><@msg.message key="std.degreeInfo"/>
         </td>
       </tr>
       </#if>
	  </table>
