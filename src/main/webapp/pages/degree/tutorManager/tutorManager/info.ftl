...
<body>
    ...
    <div style="width:90%;">
        <table class="infoTable">
            ...
            <tr valign="top">
                ...
                <td colspan="3">${(teacher.description?html?replace("\n", "<br>"))?default("")}</td>
            </tr>
            <tr>
    ...
    <script>
        ...
        bar.addItem("查看简介", "teacherIntro()", "detail.gif");
        bar.addItem("修改简介", "editDescription()");
        
        var form = document.actionForm;
        
        function teacherIntro() {
            form.action = "teacherSearch.do?method=intro";
            form.submit();
        }
        
        function editDescription() {
           form.action = "tutorManager_tutor.do?method=editDescription";
           form.submit();
        }
    </script>
</body>
