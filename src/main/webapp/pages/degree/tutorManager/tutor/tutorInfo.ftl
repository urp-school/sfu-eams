...
<#include "/templates/back.ftl"/>  
	 ...
	 <table width="90%" align="center" class="listTable">
       ...
       <tr>
	     ...
	     <td width="35%" class="brightStyle">
	         <input type="text" name="tutor.dateOfJoin" <#if tutorFlag>disabled</#if>
 ...
 <script language="javascript" > 
    ...
    function save(form){
     var a_fields = {
         'tutor.id':{'l':'<@bean.message key="attr.code" />', 'r':true, 't':'f_id','mx':'32'},
    ...
    <#if !tutorFlag>
	     a_fields[ 'tutor.secondSubject.firstSubject.firstCode']={'l':'<@bean.message key="filed.firstSubject" />','r':true,'t':'f_firstSubject'};
	     a_fields[ 'tutor.secondSubject.secondCode']={'l':'<@bean.message key="filed.secondSubject" />','r':true,'t':'f_secondSubject'};
	     a_fields[ 'tutor.thirdSubject.thirdCode']={'l':'<@bean.message key="filed.tutorAndMaster" />','r':true,'t':'f_thirdSubject'};
    </#if>
