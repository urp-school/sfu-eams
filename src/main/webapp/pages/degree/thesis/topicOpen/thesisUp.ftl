...
<#include "/templates/back.ftl"/>
       <table border=0 align='left' class="infoTitle">
          <form name="pageGoForm" action="loadThesisTopic_std.do?method=doUpThesis&flag=thesisUp&topicOpenId=${topicOpenId}"  method="post" enctype="multipart/form-data" onsubmit="return false;"> 
         <tr>
         	<td>
