...
<BODY LEFTMARGIN="0" TOPMARGIN="0">
	<table width="90%" align="center">
		<tr>
			<td align="center" class="contentTableTitleTextStyle" bgcolor="#ffffff"><B><@i18nName result.student?if_exists/><@bean.message key="info.duty.dutyRecordList"/></B></td>
		</tr>
	</table>	
	<form name="listForm" method="post" action="dutyRecordSearch.do" onSubmit="return false;" target="dutyFrame">
		...
		<tr align="center" class="darkColumn">
	        ...
	        <td align="left">
	        	...
	        	<input type="hidden" value="recordByStudent" name="method" />
...
DWREngine.setAsync(false);
		...
		<tr align="center">
			<td colspan="3">
				<iframe id="dutyFrame" name="dutyFrame" src="#<#-->javascript:setTimeout('parent.dutySearch()',1000);-->" width="100%" height="100%" frameborder="0" scrolling="no" ></iframe>
			</td>
		</tr>	
		</table>
<script>
