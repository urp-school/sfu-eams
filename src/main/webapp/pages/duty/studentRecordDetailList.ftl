      ...
      <TD HEIGHT="100%" VALIGN="TOP">       
       <table width="85%" align="center" class="listTable">
	    ...
	    <tr class="${class}" onmouseover="swapOverTR(this,this.className)" onmouseout="swapOutTR(this)">
	     ...
	     <td><@getTimeStr recordDetail.beginTime?if_exists/><#-->${recordDetail.timeBegin}--></td>
	     <td><@getTimeStr recordDetail.endTime?if_exists/><#-->${recordDetail.timeEnd}--></td>	     
	     <td>&nbsp;<@i18nName recordDetail.dutyStatus?if_exists /></td>
        </tr>
        </#list>
        </form>
       </TABLE>
