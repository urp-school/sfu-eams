...
<BODY LEFTMARGIN="0" TOPMARGIN="0">
 <table id="myBar"></table>
  ...
  <script language="javascript">
    type="building";
    keys="code,name,engName,schoolDistrict.name,abbreviation,description,createAt,modifyAt,remark,state,,,";
    titles="代码,名称,英文名,校区,简称,简介,创建日期,修改日期,备注,是否使用";
    labelInfo="<@bean.message key="page.buildingListFrame.label" />";
    search();
