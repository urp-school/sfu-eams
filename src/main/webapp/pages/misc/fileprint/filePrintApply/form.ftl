...
<table width="100%" valign="top" class="formTable">
       <form name="filePrintApplicationForm"  action="filePrintApply.do?method=save" method="post" enctype="multipart/form-data" onsubmit="return false;">
	   <tr class="darkColumn">
	   ...
	   <tr>
	     ...
	     <td colspan="3">
	     	...
	     	<a href='filePrintApply.do?method=download&filePrintApplicationId=${(filePrintApplication.id)?if_exists}'>${(filePrintApplication.fileName)?if_exists}</a>
	     </td>
	   </tr>
	   ...
	   <tr>
	     ...
	     <td >${(filePrintApplication.filePrintState)?if_exists}</td>
	   </tr>
	   <tr>
