...
<body>
	...
	<table class="frameTable_title">
      <tr>
       ...
       <td>|</td>
      <form name="filePrintApplyForm" target="filePrintApplicationFrame" method="post" action="filePrintApply.do?method=index" onsubmit="return false;">
	...
	<script>
        ...
        function searchFilePrintApplication() {
	    	var form = document.filePrintApplyForm;
	    	form.target = "filePrintApplicationFrame";
	    	form.action = "filePrintApply.do?method=search";
	    	form.submit();
	    }
