...
<body>
	...
	<table class="frameTable_title">
      <tr>
       ...
       <td>|</td>
      <form name="filePrintAuditForm" target="filePrintApplicationFrame" method="post" action="filePrintAudit.do?method=index" onsubmit="return false;">
	...
	<script>
        ...
        function searchFilePrintApplication() {
	    	var form = document.filePrintAuditForm;
	    	form.target = "filePrintApplicationFrame";
	    	form.action = "filePrintAudit.do?method=search";
	    	form.submit();
	    }
