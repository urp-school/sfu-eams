<#include "/templates/head.ftl"/>
 ...
 <body>
  <table cellpadding="0" cellspacing="0" width="100%" border="0">
   <form name="commonForm" action="auditStandardOperation.do" method="post">
   <tr>
    <td align="center" colspan="4" class="contentTableTitleTextStyle" bgcolor="#ffffff">
     <B><@bean.message key="attr.graduate.addNewGraduateAudit"/></B>
    </td>
   </tr>  
   <tr>
    <td>
	...
	<tr>
		...
		<td class="brightStyle"><input type="text" name="auditStandard.name" maxLength="50"></td>
	</tr>
	   <tr>
	   ...
	   <tr>
	    ...
	    <td class="brightStyle">
	     <textarea name="auditStandard.remark" cols="55" rows="3"></textarea>
	    </td>
	   </tr>
	   <tr class="darkColumn">
