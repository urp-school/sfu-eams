...
<BODY> 
    ...
    <table class="frameTable_title">
        <tr >
          <form name="attendStaticForm" target="attendStaticListForm" method="post" action="?method=showDetailList" onsubmit="return false;">
    ...
    <script>
        ...
        function search(){
            ...
            attendStaticForm.action = "?method=showDetail";
