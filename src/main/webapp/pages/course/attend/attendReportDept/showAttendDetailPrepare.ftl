...
<BODY> 
    <table id="attendStaticBar"></table>
    <table class="frameTable_title">
        <tr >
          <form name="attendStaticForm" target="attendStaticListForm" method="post" action="?method=showAttendDetailPrepare" onsubmit="return false;">
    ...
    <table class="frameTable">
        <tr>
            ...
            <td valign="top" bgcolor="white">
                <iframe  src="#" id="attendStaticListForm" name="attendStaticListForm" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0"  height="100%" width="100%"></iframe>
            </td>
        </tr>
    </table>
	<script>
	
		var bar=new ToolBar("attendStaticBar","学生考勤明细（院系）",null,true,true);
        search();
        function search(){
            var form = document.attendStaticForm;
            attendStaticForm.action = "?method=showAttendDetail";
