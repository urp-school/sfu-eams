...
<body >
 ...
 <script>
     ...
     function edit(){
        submitId(actionForm,"courseGradeId",false,"courseGradeDuplicate.do?method=edit");
     }
     function remove(){
        submitId(actionForm,"courseGradeId",true,"courseGradeDuplicate.do?method=remove","确认删除选择的成绩吗?\n删除成绩后，如果这们课程未发布。教师可以再次录入");
     }
  </script>
</body> 
