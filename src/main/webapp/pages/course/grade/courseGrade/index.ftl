...
<BODY>
	<table id="taskBar"></table>	
     <table  class="frameTable_title">
      <tr>
       ...
       <td>|</td>
      <form name="taskForm" target="teachTaskListFrame" method="post" action="courseGrade.do?method=index" onsubmit="return false;">
  ...
  <table>
 <script>
  var bar=new ToolBar("taskBar","教学任务成绩管理",null,true,true);
