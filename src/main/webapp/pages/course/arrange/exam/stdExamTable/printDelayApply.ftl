...
<BODY>
	...
	<script>
	  var bar=new ToolBar("taskBar","<@msg.message key="exam.printDelayApplication"/>",null,true,true);
  ...
  <table width="100%" align="center" class="listTable">
    <thead align="center">     
     ...
     <td width="25%"><B><@msg.message key="exam.date"/></B></td>
     <td width="25%"><B><@msg.message key="attr.courseFullName"/></B></td>
     <td width="30%"><B><@msg.message key="exam.delayReason"/></B></td>
    </thead>
    <tbody>
