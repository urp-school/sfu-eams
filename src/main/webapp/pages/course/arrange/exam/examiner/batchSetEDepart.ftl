...
<body  onload="DWRUtil.useLoadingMessage();">
 ...
 <script>
    var bar= new ToolBar("batchEditBar","指定或修改主考学院",null,true,true);
 ...
 <form name="taskListForm" method="post" action="" onsubmit="return false;">
    <tr align="center" class="darkColumn">
      ...
      <td width="30%">主考院系<br/>
       ...
       </select><button onclick="changeAll()">更换</button>
      </td>
    </tr>
    ...
    <script>
	    ...
	    function batchUpdate(form){
	        ...
	        form.action="examiner.do?method=saveExaminers1&type=depart";
	        form.submit();
	    }
	    function changeAll(){
