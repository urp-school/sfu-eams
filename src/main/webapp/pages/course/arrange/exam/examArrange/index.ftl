...
<BODY>
	<table id="taskBar"></table>
     <table class="frameTable_title">
      ...
      <form name="calendarForm" target="contentFrame" method="post" action="examArrange.do?method=index">
 ...
 <script>
   ...
   bar.addItem("教室利用率统计","statRoomUtilization()");
   ...
   function statRoomUtilization(){
     var form = document.calendarForm;
     form.action="examArrange.do?method=roomUtilization&ratio=0.9";
     form.submit();
   }
   ...
   function search(form,type,pageNo,pageSize,orderBy){
	    ...
	    form.action="examArrange.do?method="+type;
