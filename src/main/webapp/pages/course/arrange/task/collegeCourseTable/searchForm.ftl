	  ...
	  <table class="searchTable"  onkeypress="DWRUtil.onReturn(event, searchTask)">
	    ...
	    <tr>
	     ...
	     <td><input type="text" name="task.courseType.name" value="" style="width:100px" maxlength="20"/></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	     ...
	     <td>
	     <input name="teacher.name" value="" style="width:100px" maxlength="20"/>
	     </td>
	    </tr>
	    <tr>
	     <td class="infoTitle">教师院系:</td>
	     <td>
	     <@htm.i18nSelect name="teacher.department.id" datas=departmentList selected="" style="width:100px"><option value=""></option></@>
	     </td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	     ...
	     <td>
		     <select name="courseActvity.time.week" value="" style="width:100px">
		     	<option value=""><@bean.message key="common.all"/></option>
		     	<#list weeks as week>
	    ...
	    <tr>
	     ...
	     <td>
		     <select name="courseActvity.time.startUnit" value="" style="width:100px">
		     	<option value=""><@bean.message key="common.all"/></option>
		     	<#list 1..14 as unit>
