...
<BODY LEFTMARGIN="0" TOPMARGIN="0" onload="f_frameStyleResize(self),f_frameStyleResize(parent)">
	...
	<@table.table id="student" sortable="true" headIndex="1" width="100%">
		<form name="stdListForm" method="post" onsubmit="return false;" action="courseTakeForTaskDuplicate.do?method=stdList">
  ...
  <script>
   var bar = new ToolBar("stdListBar", "查询学号添加（实践）", null, true, true);
