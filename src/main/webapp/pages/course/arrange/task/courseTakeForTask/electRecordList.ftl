...
<form name="electRecordListForm"  method="post" action="courseTakeForTask.do?method=filter" onsubmit="return false;">
 ...
 <script>
   ...
   var bar = new ToolBar('electRecordStdBar','<@i18nName task.course/>的选课数据',null,true,true);
