...
<table width="100%" class="frameTable">
	<tr>
		<form method="post" action="roomApplyApprove.do?method=search" name="searchRoomApplyApproveForm" target="contentFrame" onsubmit="return false;">
 	...
 	<script>
        ...
        function lookFreeApply() {
        	window.open("roomApply.do?method=freeRoomHome");
        }
 	</script>
</body>
