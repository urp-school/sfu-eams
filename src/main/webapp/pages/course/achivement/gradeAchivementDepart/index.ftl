...
<BODY> 
    ...
    <table class="frameTable_title">
     <tr>
       ...
       <td>|</td>
       <form name="achivementSettingForm" target="achivementListFrame" method="post" action="gradeAchivementDepart.do?method=index" onsubmit="return false;">
       <#include "../setting.ftl" />
       </form>
     </tr>
    </table>
    ...
    <table class="frameTable">
        <tr>
            <td valign="top" width="19%" class="frameTable_view">
                <form name="achivementSearchForm" target="achivementListFrame" method="post" action="gradeAchivementDepart.do?method=index" onsubmit="return false;">
