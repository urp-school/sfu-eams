 ...
 <table id="gradeAchivementListBar"></table>
  ...
  <script>
    ...
    function exportList() {
    	...
    	form.action = "gradeAchivementInstructor.do?method=export";
    ...
    function stat() {
    	var form = document.actionForm;
    	submitId(document.actionForm, "gradeAchivementId", true, "gradeAchivementInstructor.do?method=stat", "确定要重新统计吗？");
	}
	function info() {
    	var form = document.actionForm;
    	submitId(document.actionForm, "gradeAchivementId", false, "gradeAchivementSearch.do?method=info");
	}
  </script>
</body> 
