...
<BODY LEFTMARGIN="0" TOPMARGIN="0">
	...
	<table class="frameTable_title" width="100%">
      	<tr>
       	...
       	<form name="planSearchForm" method="post" action="teachTaskGenDuplicate.do?method=index" onsubmit="return false;">
  	...
  	<table>
	<script>
		var bar = new ToolBar("taskGenBar","实践课程任务生成",null,true,true);
	    ...
	    function searchPlan(){
	       	...
	       	form.action="teachTaskGenDuplicate.do?method=teachPlanList"
