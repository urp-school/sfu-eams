   ...
   <tr>
    <td>
     ...
     <table width="80%" align="center" class="listTable">
      <tr>
       <td colspan="2" align="center" class="darkColumn"><B><@bean.message key="info.studentRecordManager.studentSearch"/></B></td>
      </tr>
      <tr>
	     <td class="grayStyle" width="25%" id="f_studentNo">&nbsp;<@bean.message key="attr.stdNo"/>：</td>
	     <td class="brightStyle">
	      <input type="text" name="student.code" value="${RequestParameters['student.code']?if_exists}"/>
	     </td>
	  </tr>
	  <tr>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" border="0">
   <tr>
    <td align="center" colspan="4" class="contentTableTitleTextStyle" bgcolor="#ffffff">
     <B><@bean.message key="info.newStudentList"/></B>
    </td>
   </tr>   
   <tr>
    <td>
     <table width="80%" align="center" class="listTable">
       <tr>
	     <td colspan="2" class="grayStyle">
	      &nbsp;<@bean.message key="info.studentClassManager.splitClass"/>：
	     </td>
       ...
       <form name="splitForm" action="studentClassOperation.do" method="post">
	   <tr align="center" class="darkColumn">
	     ...
	     <td width="25%"><@bean.message key="entity.speciality"/></td>
	   ...
	   <tr>
	    <td colspan="6" align="center" class="darkColumn">
	     <input type="hidden" name="method" value="splitClass"/>
	     <input type="hidden" name="stdId"/>
	     <input type="hidden" name="classId" value="${RequestParameters.classId}"/>
	     <input type="button" onClick="confirmForm()" value="<@bean.message key="info.ClassManager.selectStudentIntoClass"/>" name="button1" class="buttonStyle"/>&nbsp;
        </td>
	   </tr>
	   </form>
	   <tr> 
       	<td colspan="6" class="brightStyle"><@bean.message key="info.explanation.front"/><@bean.message key="info.studentClassManager.splitWarning"/></td>
   	   </tr>
     </table>
    </td>
   </tr>
