 ...
 * 
 */
public class MakeUpChecker implements RuleExecutor {
    ...
    public boolean execute(Context context) {
        ...
        // 审核 补缓考试不及格成绩
        if (null != sum) {
            List makeUpList = (List) gradeService.getWithMakeUpExamIsNotPass(result.getStd(),
                    standard.getMajorType());
            ...
            info.setDescription("补考不及格门次要求不高于" + sum + "; 实际补考不及格门次为" + makeUpList.size());
